...
class GACNet(nn.Module):
    def __init__(self, num_classes, dropout=0.2, alpha=0.2, normalize=True):
        ...
        if normalize:
            self.sa1 = GraphAttentionConvLayer(256, 0.1, 32, 3 + 5, [32, 32, 64], False, dropout, alpha)
        else:
            self.sa1 = GraphAttentionConvLayer(256, 0.1, 32, 3, [32, 32, 64], False, dropout, alpha)
        self.sa2 = GraphAttentionConvLayer(64, 0.2, 32, 64 + 3, [64, 64, 128], False, dropout, alpha)
        self.sa3 = GraphAttentionConvLayer(16, 0.4, 32, 128 + 3, [128, 128, 256], False, dropout, alpha)
...
#         l4_xyz, l4_points = self.sa4(l3_xyz, l3_points)
        ...
        net = torch.cat([torch.max(l1_points, dim=2)[0],
                         ...
                         torch.max(l3_points, dim=2)[0]], axis=-1)
        #print("net: ", net.shape)
